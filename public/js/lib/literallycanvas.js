...
(function() {
	...
	LC.LiterallyCanvas = function() {
		function LiterallyCanvas(canvas, opts) {
			...
			this.colors = {
				primary : this.opts.primaryColor || "#333",
...
(function() {
	...
	$.fn.undo = function() {
		return this.get(0).literallycanvas.undo();
	};
	$.fn.clear = function() {
		return this.get(0).literallycanvas.clear();
	};
	...
	LC.Toolbar = function() {
		...
		Toolbar.prototype.initTools = function() {
			...
			return _.each(this.tools, function(t) {
				...
				var tmpTxt = "<div class='button tool-" + t.cssSuffix + "'>          <div class='tool-image-wrapper'></div>        </div>";
				buttonEl = $(tmpTxt);
...
(function() {
	...
	LC.StrokeWidget = function(_super) {
		...
		StrokeWidget.prototype.options = function() {
			...
			var tempTxt = "<span class='brush-width-min'>1 px</span>      <input type='range' min='1' max='50' step='1' value='" + this.strokeWidth + "'>      <span class='brush-width-max'>50 px</span>      <span class='brush-width-val'>(5 px)</span>    ";
			$el = $(tempTxt);
